...
type Repository interface {
	...
	ListRecentPage(ctx context.Context, query RecentPageQuery) (RecentPage, error)
	...
	ModelStatsPageWithFilter(ctx context.Context, filter AnalyticsFilter, limit int, offset int) (ModelStatsPage, error)
	...
	AccountModelStatsWithFilter(ctx context.Context, filter AnalyticsFilter, limit int) ([]AccountModelStat, error)
	AccountModelStatsPageWithFilter(ctx context.Context, filter AnalyticsFilter, limit int, offset int) (AccountModelStatsPage, error)
	CredentialModelStatsWithFilter(ctx context.Context, filter AnalyticsFilter) ([]CredentialModelStat, error)
	CredentialModelStatsPageWithFilter(ctx context.Context, filter AnalyticsFilter, limit int, offset int) (CredentialModelStatsPage, error)
	...
	APIKeyModelStatsWithFilter(ctx context.Context, filter AnalyticsFilter, limit int) ([]APIKeyModelStat, error)
	APIKeyModelStatsPageWithFilter(ctx context.Context, filter AnalyticsFilter, limit int, offset int) (APIKeyModelStatsPage, error)

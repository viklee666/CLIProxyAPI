...
// Codex Agent Identity request-scoped auth is owned by the HTTP executor; the auto
// executor forwards the whole contract so websocket routing keeps the same behavior.

...
// ListAuthFiles serves the paginated auth-file catalog. The query path applies the
// same name and auth_index filters while bounding the response size and omitting
// heavy per-credential fields.

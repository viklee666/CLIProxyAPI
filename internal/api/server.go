...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware(), s.mgmt.RequestBodyLimitMiddleware())
	{
		mgmt.GET("/config", s.mgmt.GetConfig)
		mgmt.GET("/config/summary", s.mgmt.GetConfigSummary)
		mgmt.GET("/config.yaml", s.mgmt.GetConfigYAML)
		mgmt.PUT("/config.yaml", s.mgmt.PutConfigYAML)
		mgmt.GET("/latest-version", s.mgmt.GetLatestVersion)
		mgmt.GET("/plugins", s.mgmt.ListPlugins)
		mgmt.GET("/plugins/routes", s.mgmt.ListPluginRoutes)
		...
		mgmt.POST("/interactions-api-key", s.mgmt.PostInteractionsKey)
		...
		mgmt.GET("/routing/adaptive", s.mgmt.GetAdaptiveRouting)
		mgmt.PUT("/routing/adaptive", s.mgmt.PutAdaptiveRouting)
		mgmt.PATCH("/routing/adaptive", s.mgmt.PutAdaptiveRouting)
		mgmt.GET("/routing/adaptive/scores", s.mgmt.GetAdaptiveRoutingScores)

		mgmt.GET("/claude-api-key", s.mgmt.GetClaudeKeys)
		mgmt.POST("/claude-api-key", s.mgmt.PostClaudeKey)
		mgmt.PUT("/claude-api-key", s.mgmt.PutClaudeKeys)
		mgmt.PATCH("/claude-api-key", s.mgmt.PatchClaudeKey)
		mgmt.DELETE("/claude-api-key", s.mgmt.DeleteClaudeKey)

		mgmt.GET("/codex-api-key", s.mgmt.GetCodexKeys)
		mgmt.POST("/codex-api-key", s.mgmt.PostCodexKey)
		mgmt.PUT("/codex-api-key", s.mgmt.PutCodexKeys)
		mgmt.PATCH("/codex-api-key", s.mgmt.PatchCodexKey)
		mgmt.DELETE("/codex-api-key", s.mgmt.DeleteCodexKey)

		mgmt.GET("/xai-api-key", s.mgmt.GetXAIKeys)
		mgmt.POST("/xai-api-key", s.mgmt.PostXAIKey)
		...
		mgmt.POST("/vertex-api-key", s.mgmt.PostVertexCompatKey)
		...
		mgmt.POST("/auth-files/download", s.mgmt.DownloadAuthFilesBatch)
		mgmt.POST("/auth-files", s.mgmt.UploadAuthFile)
		mgmt.DELETE("/auth-files", s.mgmt.DeleteAuthFile)
		mgmt.PATCH("/auth-files/status", s.mgmt.PatchAuthFileStatus)
		mgmt.PATCH("/auth-files/status/batch", s.mgmt.PatchAuthFileStatusBatch)

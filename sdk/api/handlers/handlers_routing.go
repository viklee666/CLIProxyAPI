...
// providersForExecutionForContext resolves providers with the caller's client-access metadata in
// scope so tenant keys never fall through to the global Home control plane.
